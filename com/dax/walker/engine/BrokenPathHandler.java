...
public class BrokenPathHandler {
    ...
    public enum NextMove {
        ...
        SAME_FLOOR(Pattern.compile("(Use|pass(?i-m)|(walk|jump|climb).(across|over|under|into)|(open|push|enter)|(.+.through)|cross|board)")); //Not sure if this is the correct way to add it.
